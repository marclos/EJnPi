...
fire = subset(cleandata, 
  subset=
    DateTime >= as.Date("2020-10-26 00:00:00") & 
    DateTime <= as.Date("2020-10-28 00:00:00"))
str(fire)
@
...
plot(pm25_cf ~ DateTime, data=mean30min, ty="l", ylab="Date")
plot(pm25_cf ~ DateTime, data=mean30min, ty="p",
  pch=20, cex=.4, xlim=c(as.POSIXct("2020-10-26 20:00:00"), 
  as.POSIXct("2020-10-27 23:59:59")), ylab="Conc", xaxt = "n", xlab="Time")
...
abline(v=as.POSIXct(c("2020-10-26 00:00:00", 
  "2020-10-27 00:00:00", "2020-10-28 00:00:00")))
