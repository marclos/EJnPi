...
rect(as.POSIXct("2020-10-21 7:00:00 UTC"), -20, as.POSIXct("2020-10-21 18:00:00 UTC"), 330, border = NA, col= rgb(0,0,1.0,alpha=0.1))

rect(as.POSIXct("2020-10-22 7:00:00 UTC"), -20, as.POSIXct("2020-10-22 18:00:00 UTC"), 330, border = NA, col= rgb(0,0,1.0,alpha=0.1))

rect(as.POSIXct("2020-10-23 7:00:00 UTC"), -20, as.POSIXct("2020-10-23 18:00:00 UTC"), 330, border = NA, col= rgb(0,0,1.0,alpha=0.1))

rect(as.POSIXct("2020-10-24 7:00:00 UTC"), -20, as.POSIXct("2020-10-24 18:00:00 UTC"), 330, border = NA, col= rgb(0,0,1.0,alpha=0.1))

rect(as.POSIXct("2020-10-25 7:00:00 UTC"), -20, as.POSIXct("2020-10-25 18:00:00 UTC"), 330, border = NA, col= rgb(0,0,1.0,alpha=0.1))

rect(as.POSIXct("2020-10-26 7:00:00 UTC"), -20, as.POSIXct("2020-10-26 18:00:00 UTC"), 330, border = NA, col= rgb(0,0,1.0,alpha=0.1))

rect(as.POSIXct("2020-10-27 7:00:00 UTC"), -20, as.POSIXct("2020-10-27 18:00:00 UTC"), 330, border = NA, col= rgb(0,0,1.0,alpha=0.1))

rect(as.POSIXct("2020-10-28 7:00:00 UTC"), -20, as.POSIXct("2020-10-28 18:00:00 UTC"), 330, border = NA, col= rgb(0,0,1.0,alpha=0.1))
...
#seq(min(cleandata$DateTime), max(cleandata$DateTime), by="days")

#rect(as.POSIXct("2020-10-21 8:00:00 UTC"), 0, as.POSIXct("2020-10-22 18:00:00 UTC", 300)
 
#axis.Date(3, at=seq(min(cleandata$DateTime), max(cleandata$DateTime), by="days"), format="%d")    
#axis(3, cleandata$DateTime, format(cleandata$DateTime, "%a"), cex.axis = .7,  tck=0)#, at=axis.lab, labels=axis.lab)
#axis.Date(1, at = seq(as.Date("2020-10-21 14:32:25 UTC"), as.Date("2020-10-2714:32:25 UTC "), "days"))
#axis.Date(1, at = seq(as.Date("2001/1/1"), max(random.dates)+6, "days"), labels = FALSE, tcl = -0.2)
