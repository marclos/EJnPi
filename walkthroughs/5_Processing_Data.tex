...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in file(file, "{}rt"{}): cannot open file '/home/CAMPUS/mwl04747/github/EJnPi/data/201104\_Complete\_airquality.csv': No such file or directory}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in names(rawdata) = c("{}X1"{}, "{}X2"{}, "{}Month"{}, "{}Day"{}, "{}Hour"{}, "{}Minute"{}, : object 'rawdata' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.factor(x): object 'rawdata' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in with(rawdata, paste("{}2020"{}, Month, Day, sep = "{}-"{})): object 'rawdata' not found}}\begin{alltt}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The following objects are masked from 'package:base':\\\#\# \\\#\# \ \ \ \ date, intersect, setdiff, union}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in with(rawdata, ymd\_hms(paste("{}2020"{}, Month, Day, Hour, Minute, : object 'rawdata' not found}}\end{kframe}
\end{knitrout}

As always, I check my data! NOTE: I imported the data in a combined csv. If you have seperate csv files, you'll need to create unique filepaths for each and then read them into unique dataframes and then use rbind() to put them together. This requires that all the dataframes have the same number of columns -- check this!!!
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in subset(rawdata, select = c(DateTime, pm1\_cf, pm25\_cf, pm10\_cf)): object 'rawdata' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in hist(cleandata\$pm25\_cf, xlab = "{}PM2.5 concentration"{}, main = "{}Histogram of PM2.5 in Claremont"{}, : object 'cleandata' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(m\$data, eframe): object 'cleandata' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in rect(as.POSIXct("{}2020-10-21 18:00:00 UTC"{}) + offset, -20, as.POSIXct("{}2020-10-21 6:00:00 UTC"{}) + : plot.new has not been called yet}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in rect(as.POSIXct("{}2020-10-21 18:00:00 UTC"{}) + offset, -20, as.POSIXct("{}2020-10-21 6:00:00 UTC"{}) + : plot.new has not been called yet}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in mean(cleandata\$pm1\_cf): object 'cleandata' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in day\$pm25\_cf: object of type 'closure' is not subsettable}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in subset(cleandata, subset = DateTime >= as.POSIXct("{}2020-10-26 04:10:00"{}, : object 'cleandata' not found}}\begin{alltt}
\hlkwd{str}\hlstd{(fire)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in str(fire): object 'fire' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(m\$data, eframe): object 'fire' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in library(package, lib.loc = lib.loc, character.only = TRUE, logical.return = TRUE, : there is no package called 'dplyr'}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cleandata \%>\% group\_by(DateTime = cut(DateTime, breaks = "{}5 min"{})) \%>\% : could not find function "{}\%>\%"{}}}\end{kframe}
\end{knitrout}


\noindent Or for 30 min means...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{require}\hlstd{(dplyr)}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cleandata \%>\% group\_by(DateTime = cut(DateTime, breaks = "{}30 min"{})) \%>\% : could not find function "{}\%>\%"{}}}\end{kframe}
\end{knitrout}

\noindent Or daily means...
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in library(package, lib.loc = lib.loc, character.only = TRUE, logical.return = TRUE, : there is no package called 'dplyr'}}\begin{alltt}
\hlstd{meandaily} \hlkwb{=} \hlstd{cleandata} \hlopt{%>%}
  \hlkwd{group_by}\hlstd{(}\hlkwc{DateTime} \hlstd{=} \hlkwd{cut}\hlstd{(DateTime,} \hlkwc{breaks}\hlstd{=}\hlstr{"1 day"}\hlstd{))} \hlopt{%>%}
  \hlkwd{summarize}\hlstd{(}\hlkwc{pm25_cf} \hlstd{=} \hlkwd{mean}\hlstd{(pm25_cf))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cleandata \%>\% group\_by(DateTime = cut(DateTime, breaks = "{}1 day"{})) \%>\% : could not find function "{}\%>\%"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in head(mean30min): object 'mean30min' not found}}\begin{alltt}
\hlkwd{str}\hlstd{(mean30min)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in str(mean30min): object 'mean30min' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.POSIXct(mean30min\$DateTime, format = "{}\%Y-\%m-\%d \%H:\%M:\%S"{}): object 'mean30min' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in axis(side, at = z, labels = labels, ...): plot.new has not been called yet}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in axis(side, at = z, labels = labels, ...): plot.new has not been called yet}}\end{kframe}
\end{knitrout}
