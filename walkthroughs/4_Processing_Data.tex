...
## 1194 OrderedDict([('DateTime'  datetime.datetime(2020    10  23   23     52
## 3437 OrderedDict([('DateTime'  datetime.datetime(2020    10  30    2     55
## 4167 OrderedDict([('DateTime'  datetime.datetime(2020    10  31   10     27
## 5724 OrderedDict([('DateTime'  datetime.datetime(2020    11   3   20     50
## 4502                                                     NA  NA   NA     NA
##      Second        X3         X4 pm1_cf          X5 pm25_cf          X6 pm10_cf
## 1194     39  345497))  ('pm1_cf'     16  ('pm25_cf'      29  ('pm10_cf'      30
## 3437     31  784143))  ('pm1_cf'      5  ('pm25_cf'       7  ('pm10_cf'       8
## 4167     34  766140))  ('pm1_cf'      5  ('pm25_cf'       7  ('pm10_cf'       7
## 5724     55  975425))  ('pm1_cf'     25  ('pm25_cf'      45  ('pm10_cf'      53
## 4502     NA                          NA                  NA                  NA
##           X7  pm1       X8 pm25    pm10.     X9            DateTime
## 1194  ('pm1'  16)  ('pm25'  29)  ('pm10'  30)]) 2020-10-23 23:52:39
## 3437  ('pm1'   5)  ('pm25'   7)  ('pm10'   8)]) 2020-10-30 02:55:31
## 4167  ('pm1'   5)  ('pm25'   7)  ('pm10'   7)]) 2020-10-31 10:27:34
## 5724  ('pm1'  23)  ('pm25'  39)  ('pm10'  50)]) 2020-11-03 20:50:55
## 4502                                                           <NA>
\end{verbatim}
\begin{alltt}
