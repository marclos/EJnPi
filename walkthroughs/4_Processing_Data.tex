...
## 1760 OrderedDict([('DateTime'  datetime.datetime(2020    10  26    6     19
## 186  OrderedDict([('DateTime'  datetime.datetime(2020    10  21   17     46
## 1318 OrderedDict([('DateTime'  datetime.datetime(2020    10  24   14     35
## 306  OrderedDict([('DateTime'  datetime.datetime(2020    10  21   19     53
## 311  OrderedDict([('DateTime'  datetime.datetime(2020    10  21   19     58
##      Second        X3         X4 pm1_cf          X5 pm25_cf          X6 pm10_cf
## 1760     10   22440))  ('pm1_cf'      4  ('pm25_cf'       9  ('pm10_cf'      15
## 186      16  353950))  ('pm1_cf'     37  ('pm25_cf'      68  ('pm10_cf'      84
## 1318     24  658429))  ('pm1_cf'     10  ('pm25_cf'      15  ('pm10_cf'      15
## 306      36  535979))  ('pm1_cf'     19  ('pm25_cf'      33  ('pm10_cf'      38
## 311      57  842901))  ('pm1_cf'     18  ('pm25_cf'      35  ('pm10_cf'      35
##           X7  pm1       X8 pm25    pm10.     X9            DateTime
## 1760  ('pm1'   4)  ('pm25'   9)  ('pm10'  15)]) 2020-10-26 06:19:10
## 186   ('pm1'  29)  ('pm25'  49)  ('pm10'  66)]) 2020-10-21 17:46:16
## 1318  ('pm1'  10)  ('pm25'  15)  ('pm10'  15)]) 2020-10-24 14:35:24
## 306   ('pm1'  19)  ('pm25'  32)  ('pm10'  38)]) 2020-10-21 19:53:36
## 311   ('pm1'  18)  ('pm25'  33)  ('pm10'  35)]) 2020-10-21 19:58:57
\end{verbatim}
\begin{alltt}
