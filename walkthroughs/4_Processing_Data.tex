...
## 1603 OrderedDict([('DateTime'  datetime.datetime(2020    10  25   15     23
## 674  OrderedDict([('DateTime'  datetime.datetime(2020    10  22    4      3
## 1343 OrderedDict([('DateTime'  datetime.datetime(2020    10  24   16     51
## 351  OrderedDict([('DateTime'  datetime.datetime(2020    10  21   20     44
## 589  OrderedDict([('DateTime'  datetime.datetime(2020    10  22    1     48
##      Second        X3         X4 pm1_cf          X5 pm25_cf          X6 pm10_cf
## 1603     34  333076))  ('pm1_cf'      2  ('pm25_cf'       4  ('pm10_cf'       4
## 674      16  572775))  ('pm1_cf'     34  ('pm25_cf'      70  ('pm10_cf'      85
## 1343      8  516094))  ('pm1_cf'     12  ('pm25_cf'      19  ('pm10_cf'      20
## 351      31  945709))  ('pm1_cf'     22  ('pm25_cf'      44  ('pm10_cf'      52
## 589      39  190381))  ('pm1_cf'     36  ('pm25_cf'      75  ('pm10_cf'      89
##           X7  pm1       X8 pm25    pm10.     X9            DateTime
## 1603  ('pm1'   2)  ('pm25'   4)  ('pm10'   4)]) 2020-10-25 15:23:34
## 674   ('pm1'  27)  ('pm25'  49)  ('pm10'  66)]) 2020-10-22 04:03:16
## 1343  ('pm1'  12)  ('pm25'  19)  ('pm10'  20)]) 2020-10-24 16:51:08
## 351   ('pm1'  21)  ('pm25'  38)  ('pm10'  49)]) 2020-10-21 20:44:31
## 589   ('pm1'  28)  ('pm25'  51)  ('pm10'  68)]) 2020-10-22 01:48:39
\end{verbatim}
\begin{alltt}
