...
\newline
\begin{center}
\includegraphics[scale=0.50]{GPIOlayout}\label{GPIO}
\end{center}
...
\begin{figure}
\includegraphics[width=0.90\textwidth]{bbledres}
...
\item Now, double check your wiring and make sure it's right! It should look something like Figure~\ref{}.
\begin{figure}
...
\begin{figure}
\includegraphics[width=0.90\textwidth]{ledon_dark}
\end{figure}
