...
\begin{itemize}
  \item Edit the rc.local file to include the path of your script that you want to run. In our case, it's whatever python file.
  \item Modify the Pi Configuration Utility and change the Boot option to: ``Boot To CLI''.
\end{itemize}
