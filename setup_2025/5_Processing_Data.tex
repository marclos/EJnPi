...
\title{Processing RPi Data with R}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'dplyr' was built under R version 4.2.2}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in group\_by(., DateTime = cut(DateTime, breaks = "{}5 min"{})): object 'cleandata' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in group\_by(., DateTime = cut(DateTime, breaks = "{}30 min"{})): object 'cleandata' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in group\_by(., DateTime = cut(DateTime, breaks = "{}1 day"{})): object 'cleandata' not found}}\end{kframe}
\end{knitrout}
