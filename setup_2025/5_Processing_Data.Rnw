...
rect(as.POSIXct("2020-10-21 18:00:00 UTC")+offset, 
     -20, as.POSIXct("2020-10-21 6:00:00 UTC")+offset, 
...
<<echo=F>>=
par(mfrow=c(1,1))
plot(pm25_cf ~ DateTime, data=fire)
@
...
\begin{figure}
<<dual, fig=TRUE, width=6, height=4 >>=
