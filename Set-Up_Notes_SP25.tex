...
\begin{description}
  \item[bme280\_v2.py] This program uses the BME280 sensor to read temperature, pressure, and humidity, but writes the data to a CSV file (bme280\_data.csv) every XX seconds. 
  
NOTE: I will rename this as EA30\_bme280.py to reflect the fact that it is the EA30 version of the BME280 sensor. I would like to get the data out of this folder... to be continued.
...
Results...
\begin{description}
  \item[Enviroplus\_v0.py] This program ...crashes: 
  
  File "/home/pi/EJnPi/code25/enviroplus\_v0.py", line 22, in <module>
    from pms5003 import PMS5003
    
Doesn't import the PMS5003 library -- somehow the path is a problem. 
...
ImportError: cannot import name 'PMS5003' from 'pms5003' (/home/pi/EJnPi/code25/pms5003.py)
